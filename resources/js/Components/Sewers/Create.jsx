    ...
    return (
        <GlobalLayout> {/* Wrap with GlobalLayout */}
            <form onSubmit={handleSubmit}>
                ...
                <Select className="ml-2"aria-label="Default select example"onChange={(e) => setData("productionhouseid", e.target.value)}required>      
                ...
                <Select className="ml-2"aria-label="Default select example"onChange={(e) => setData("productionunitid", e.target.value)}required>      
